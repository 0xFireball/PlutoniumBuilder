        ...
        , IDesignerEventService
    {
        ...
        object IServiceProvider.GetService(Type serviceType)
        {
            ...
            if (serviceContainer != null)
            {
                ...
                //
                Eto_Builder.ServiceRequests requests = (Eto_Builder.ServiceRequests)serviceContainer.GetService(typeof(Eto_Builder.ServiceRequests));
                if (requests != null)
                {
                    if (service != null)
                    {
        ...
        #endregion Implementation of IDesignerEventService
    }
}